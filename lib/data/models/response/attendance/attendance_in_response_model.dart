...
class AttendanceInResponseModel {
  ...
  factory AttendanceInResponseModel.fromJson(String str) =>
      AttendanceInResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AttendanceInResponseModel.fromMap(Map<String, dynamic> json) =>
      AttendanceInResponseModel(
