...
class HistoryResponseModel {
    ...
    factory HistoryResponseModel.fromMap(Map<String, dynamic> json) => HistoryResponseModel(
        title: json["title"],
        ...
        priodDate: json["priodDate"] == null ? [] : List<DateTime>.from(json["priodDate"]!.map((x) => DateTime.parse(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "histories": histories == null ? [] : List<dynamic>.from(histories!.map((x) => x.toMap())),
        "priodDate": priodDate == null ? [] : List<dynamic>.from(priodDate!.map((x) => "${x.year.toString().padLeft(4, '0')}-${x.month.toString().padLeft(2, '0')}-${x.day.toString().padLeft(2, '0')}")),
